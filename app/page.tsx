  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center py-24 px-6 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight bg-gradient-to-b from-gray-500 to-black dark:from-white dark:to-gray-500 bg-clip-text text-transparent leading-tight pb-2">
