      ...
      <div className="mb-6 p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            disabled={processing}
            className="shrink-0 flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors"
          >
            {processing && (
        ...
        {processing && (
          <p className="text-xs mt-3 text-zinc-400">
            Chunking transcript, generating embeddings, and extracting intelligence — this may take a minute for long content.
          </p>
        )}
